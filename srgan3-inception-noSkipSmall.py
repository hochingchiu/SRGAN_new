...
from model_inception_noSkipSmall import Generator, Discriminator

print('Changed original residual block to inception block - refer to model - and also deleted skip connection  since it might shit at the elementwise addition if use inception (delete the skip within residual block here)' )


# In[6]:

timenow = datetime.datetime.now().strftime("%Y%m%d-%H%M-inception_noSkipSmall")
