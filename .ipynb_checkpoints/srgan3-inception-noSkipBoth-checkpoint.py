...
from model_inception_noSkipBoth import Generator, Discriminator

print('Changed original residual block to inception block - refer to model - and also deleted skip connection  since it might shit at the elementwise addition if use inception (delete both here)' )
