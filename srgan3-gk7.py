...
from model_gk7 import Generator, Discriminator ####################################################################model 3

print('run model gk7, residual block in g - k size 7' )


# In[6]:

timenow = datetime.datetime.now().strftime("%Y%m%d-%H%M-gk7")
